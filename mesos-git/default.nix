{ stdenv, lib, makeWrapper, fetchgit, curl, sasl, openssh, autoconf
...
in stdenv.mkDerivation rec {
 ...
 src = fetchgit {
   url = "https://git-wip-us.apache.org/repos/asf/mesos.git";
   rev = "d1b681f140fbae58001f96b4b4b8a4a0cadb6a6b";
   sha256 = "0izlq67fyvng2ybznq93g7kx2qrb3g0qdn11yy7qlm2vniqwbva0";
 };
